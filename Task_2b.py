...
def bot(balance_candies: int):
    bot_turn = 0
    if balance_candies <= 28:
        bot_turn = balance_candies
    elif balance_candies % 5 == 0:
        bot_turn = random.randint(1, 5) * 5
    elif balance_candies % 5 != 0:
